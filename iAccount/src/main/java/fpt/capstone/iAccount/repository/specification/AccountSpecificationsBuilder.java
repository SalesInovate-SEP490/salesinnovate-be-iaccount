package fpt.capstone.iAccount.repository.specification;
...
public class AccountSpecificationsBuilder {
    ...
    // API
    public AccountSpecificationsBuilder with(final String key, final String operation, final Object value) {
        return with(null, key, operation, value);
    }

    public AccountSpecificationsBuilder with(final String orPredicate, final String key, final String operation, final Object value) {
